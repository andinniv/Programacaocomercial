...
function ExibirItem({ item, navigation }) {
  function goToDetalhes() {
    navigation.navigate("HamburguerDetalhes", { item: item });
  }
...
export default function HamburguerList({ navigation }) {
  const [hamburguers, setHamburegues] = useState([]);
